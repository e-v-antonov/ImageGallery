...
namespace ImageGallery.ViewModels.AccountModel
{
    public class UserEditViewModel
    {
        ...
        [RegularExpression(@"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).\S+$", ErrorMessage = "Пароль должен обязательно содержать хотя бы строчную и заглавную английскую букву, цифру и специальный символ")]
